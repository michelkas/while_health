...
class SecurityTests(TestCase):
    ...
    def test_patient_lookup_returns_minimal_data(self):
        """✅ P1.2: Patient lookup doesn't expose sensitive data"""
        ...
        if response.status_code == 200:
            data = response.json()
            # Should NOT include email, address
            self.assertNotIn('email', data.get('patient', {}))
            self.assertNotIn('adress', data.get('patient', {}))
